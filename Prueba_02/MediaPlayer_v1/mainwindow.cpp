...
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/1.wav");
}

void MainWindow::on_num_2_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/2.wav");
}

void MainWindow::on_num_3_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/3.wav");

}

void MainWindow::on_num_4_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/4.wav");

}

void MainWindow::on_num_5_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/5.wav");

}

void MainWindow::on_num_6_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/6.wav");

}

void MainWindow::on_num_7_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/7.wav");

}

void MainWindow::on_num_8_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/8.wav");

}

void MainWindow::on_num_9_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/9.wav");

}

void MainWindow::on_num_0_clicked()
{
    jack::play("/home/fabimarin/git_workspace/DSP_Proyecto_Final/0.wav");
...
void MainWindow::on_numeral_clicked()
{
    ...
    for (int i = 0; i<=7; i++){
        if (array[i]==0){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/0.wav");
        }
        else if (array[i]==1){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/1.wav");
        }
        else if (array[i]==2){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/2.wav");
        }
        else if (array[i]==3){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/3.wav");
        }
        else if (array[i]==4){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/4.wav");
        }
        else if (array[i]==5){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/5.wav");
        }
        else if (array[i]==6){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/6.wav");
        }
        else if (array[i]==7){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/7.wav");
        }
        else if (array[i]==8){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/8.wav");
        }
        else if (array[i]==9){
            jack::playAlso("/home/fabimarin/git_workspace/DSP_Proyecto_Final/9.wav");
        }
    }
